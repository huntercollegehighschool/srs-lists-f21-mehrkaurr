...
def test_greater_than_mean():
  assert Program4.above_average([1, 3, 5, 7, 9, 11]) == [7, 9, 11], '[1, 3, 5, 7, 9, 11] should return [7, 9, 11] (average 6)'

  assert Program4.above_average([3, 20, 3, 2, 5]) == [20], '[3, 20, 3, 2, 5] should return [20] (average 6.6)'
